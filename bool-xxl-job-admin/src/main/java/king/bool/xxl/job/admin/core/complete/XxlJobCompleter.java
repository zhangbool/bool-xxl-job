package king.bool.xxl.job.admin.core.complete;
            ...
            if (xxlJobInfo!=null && xxlJobInfo.getChildJobId()!=null && xxlJobInfo.getChildJobId().trim().length()>0) {
                ...
                for (int i = 0; i < childJobIds.length; i++) {
                    ...
                    if (childJobId > 0) {
                        ...
                        ResultModel triggerChildResult = ResultModel.SUCCESS;
                        ...
                        triggerChildMsg += MessageFormat.format(I18nUtil.getString("jobconf_callback_child_msg1"),
                                ...
                                childJobIds.length,
                                childJobIds[i],
                                (triggerChildResult.getCode()==ResultModel.SUCCESS_CODE?I18nUtil.getString("system_success"):I18nUtil.getString("system_fail")),

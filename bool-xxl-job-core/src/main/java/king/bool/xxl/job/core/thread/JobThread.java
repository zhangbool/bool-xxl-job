...
public class JobThread extends Thread {
     ...
     * @return
     */
    public ResultModel pushTriggerQueue(TriggerParam triggerParam) {
        // avoid repeat
        if (triggerLogIdSet.contains(triggerParam.getLogId())) {
            log.info(">>>>>>>>>>> repeate trigger job, logId:{}", triggerParam.getLogId());
            return new ResultModel(ResultModel.FAIL_CODE, "repeate trigger job, logId:" + triggerParam.getLogId());
        }

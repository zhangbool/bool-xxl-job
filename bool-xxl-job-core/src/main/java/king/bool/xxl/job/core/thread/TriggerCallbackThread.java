...
import king.bool.xxl.job.core.context.XxlJobContext;
...
import king.bool.xxl.job.core.util.FileUtil;
import king.bool.xxl.job.core.util.JdkSerializeTool;
...
public class TriggerCallbackThread {
    ...
    private void doCallback(List<HandleCallbackParam> callbackParamList){
        ...
        for (AdminBiz adminBiz: XxlJobExecutor.getAdminBizList()) {
            try {
                ResultModel callbackResult = adminBiz.callback(callbackParamList);
                if (callbackResult!=null && ResultModel.SUCCESS_CODE == callbackResult.getCode()) {
